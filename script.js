...
This is a fully client-side application. Your content never leaves your browser and stays secure on your device.`;
  ...
  window.openFile = function(content, fileName) {
    // Check if we have a "Welcome to Markdown" tab that we created, and replace it
    var welcomeTabIndex = tabs.findIndex(function(t) { return t.name === 'Welcome to Markdown' && t.content === sampleMarkdown; });
